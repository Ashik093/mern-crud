...
import { ReadById, Update } from './../../apiServices/ProductService';
    ...
    <div className="container mt-5"  ref={(div)=>form=div}>
      ...
      <div class="row">
        <div className='col-md-4'>
          <button onClick={submit} className="btn btn-primary">Update</button>
        </div>
      </div>
    </div>
